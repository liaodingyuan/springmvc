package basecc.DataStructure.rbtree;
...
public class RBTree<T extends Comparable<T>> {
	 ...
	 * </p>
	 * <p>
	 * Description: 红黑色树节点一共有五个性质：parent、color、leftChild、rightChild、key
	 * </p>
	 * <p>
	 * Company:
	 * </p>
	 ...
	 * 后继节点：如果有右子树的话，也就是右子树中最小的值，先向右走，然后一直向左走，走到最后。
	 */
